...
console.log(money.toFormattedString()); // Output: ¥150

// 20% discount
money = money100.addPercent(-20);
console.log(money.toFormattedString()); // Output: ¥80

// Add rate
money = money100.addRate(0.1);
console.log(money.toFormattedString()); // Output: ¥110

// Subtract 50 CNY from the money
money = money100.subtract(money50);
console.log(money.toFormattedString()); // Output: ¥50

// Multiply
money = money100.multiply(2);
console.log(money.toFormattedString()); // Output: ¥200
